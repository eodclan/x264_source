...
function radio()
{
  document.getElementById("doRwunsch('shbox_text')").style.color = "red";	
}
...
function showteambox()
{
  ...
  if (TeamboxHidden.value == 'no')
  {
    ...
    SBTruncate.value     = 'Losche Teambox';
...
function edToolbar(obj, url, png)
{
  ...
  document.write("<div id=\"font\" style=\"display: none; position: relative;\" class=\"btn btn-flat btn-primary fc-today-button dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">\n");
  for (var i = 0; i < fontoptions.length; i++)
  {
    document.write("  <div style=\"font-family:'" + fontoptions[i] + "'; color: #000000;\" onClick=\"doSetFont('" + fontoptions[i] + "','" + obj + "')\">" + fontoptions[i] + "</div>\n");
  }
  document.write("</div>\n");

  document.write("<div id=\"size\" style=\"display: none; position: relative;\" class=\"btn btn-flat btn-primary fc-today-button dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">\n");

  for (var i = 0; i < sizeoptions.length; i++)
  {
    document.write("  <font size=\"" + sizeoptions[i] + "\" color=\"#000000\" onClick=\"doSetSize('" + sizeoptions[i] + "','" + obj + "')\">" + sizeoptions[i] + "</font><br \/>\n");
  }
  document.write("</div>\n");

  document.write("<div id=\"color\" style=\"display: none; position: relative;\" class=\"btn btn-flat btn-primary fc-today-button dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">\n");
  for (var i = 0; i < coloroptions.length; i++)
  {
    ...
    document.write("  <div style=\"background-color: " + coloroptions[i] + "; width: 15px; height: 15px; float: left;\" onClick=\"doSetColor('" + coloroptions[i] + "','" + obj + "')\"></div>\n");
  }
  document.write("</div>\n");
}
...
function edSmilye(obj, url, anz)
{
  ...
  for (var i = 0; i < smilieliste.length; i++)
  {
    ...
    document.write("  <div style=\"float:left; text-align:center;  width:30px; height:30px;\"><a src=\"" + url +  "/" + bild + "\" name=\"\" title=\"" + code + "\" onClick=\"doAddTags('"  + code + "','','" + obj + "')\" \/></div>\n");
  }
  document.write("</div>\n");
}
...
{
  this.AjaxFailedAlert = "Aao a?aoca? ia iiaaa??eaaao ?anoe?aiiua aicii?iinoe oi?aaeaiey naeoii, iu ianoiyoaeuii ?aeiiaiaoai niaieou a?aoca?.\n";
