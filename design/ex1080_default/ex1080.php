...
@import url("css/x264_imghost_v2.php");
@import url("css/x264_pager.php");
@import url("css/ex1080_aj_tf.php");
...
header.navbar {
  ...
  header.navbar .navbar-brand {
    ...
    margin-right: 0;
    color: #FFFFFF;
  background url(../ex1080_default/img/mainnavbg.png) -30px center repeat-x;
  border-bottom: 1px solid rgb(35,35,35);
...
.breadcrumb>li+li:before{content:"/ ";padding:0 5px;color:#444}
