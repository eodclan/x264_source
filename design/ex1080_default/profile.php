	...
	CheckIfEdit('giveup');
                    ...
                    <div class='row'>
                        <div class='col-lg-12'>
                            <div class='card'>
                                <div class='card-header'>
                                    <i class='fa fa-envelope-o'></i> Nachrichten System
                                    <div class='card-actions'>
                                        <a href='#' class='btn-close'><i class='icon-close'></i></a>
                                    </div>
                                </div>
		...
		if($messages){?>
							<tr>	
								<td>Posteingang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_INBOX;?>" class="new_my_smal_but"><?=$messages;?> PM´s - (<?if($unread == ''){echo '0';}else{echo $unread;}?> ungelesene)</a></td>
                            </tr>
			<?if ($outmessages){?>		
							<tr>	
								<td>Postausgang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_OUTBOX;?>" class="new_my_smal_but"><?=$outmessages;?></a></td>
                            </tr>
			<?}else{?>
							<tr>	
								<td>Postausgang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_OUTBOX;?>" class="new_my_smal_but">leer</a></td>
                            </tr>
			<?}?>	
			
		<?}else{?>
							<tr>	
								<td>Posteingang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_INBOX;?>" class="new_my_smal_but">leer</a></td>
                            </tr>
			<?if($outmessages){?>
							<tr>	
								<td>Postausgang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_OUTBOX;?>" class="new_my_smal_but"><?=$outmessages;?> PM´s</a></td>
                            </tr>
			<?}else{?>
							<tr>	
								<td>Postausgang:</td><td><a href="messages.php?folder=<?=PM_FOLDERID_OUTBOX;?>" class="new_my_smal_but">leer</a></td>
