...
if (intval($_GET['session'] == 1))
{
  setcookie("x264_skeyc", "dccc6c1fa2b15e4523ac10bc21bea12187eebb682c0425357e9043825c3af4c7", time()+(3600*24));
...
<head>
			...
			<meta http-equiv='refresh' content='3; URL=/nosession.php'>
</head>
...
<div id='loading-layer'></div>
    <header class='app-header navbar'>
        ...
        <a class='navbar-brand' href='index.php'>€X1080 Source</a>
	   ...
	   <nav class='sidebar-nav'>	
        ...
        <main class='main'>
					...
					Bitte Warten. Ihre Session wird geprüft.....
					<script type='text/javascript'>
						window.location.href='sessioncheck.php?session=1';
					</script>
                                </div>
                            </div>
                        </div>
