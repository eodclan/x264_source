...
select, torrent, .torrent, input[type=file] {
...
select, submit, button, seedspeed, quote {
	font-size: 11px;
	margin:4px; 
	padding:1px; 
	color:#ccc; 
...
.textarea, select, input, input.noborder, submit, button, quote, seedspeed:hover {
	font-size: 11px;
	margin:4px; 
	padding:1px; 
	color:#ccc; 
...
.textarea, select, input, input.noborder, submit, button, quote, seedspeed:active {
	font-size: 11px;
	margin:4px; 
	padding:1px; 
	color:#ccc; 
...
.small.button, textarea, select, input, input.noborder, submit, seedspeed, quote, submit:visited {
	font-size: 11px; 
	margin:4px; 
	padding:1px; 
	color:#ccc; 
...
textarea, select, input, input.noborder, submit, button, seedspeed, quote {
	font-size: 11px;
	margin:4px; 
	padding:1px; 
	color:#ccc; 
