...
echo("
        ...
        <footer class='footer'>
            <span class='text-left'>
                <b>Backend ACP V:</b> ".$GLOBALS["X264_STAFFACP_VERSION"]."
            </span>
            <span class='pull-right'>
                Powered by D€ Source 2017 Version ".$GLOBALS["X264VERSION"]." | ".$GLOBALS["X264COPYRIGHT"]."
            </span>
        </footer>
        <!-- Bootstrap and necessary plugins -->
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/libs/jquery.min.js'></script>
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/libs/tether.min.js'></script>
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/libs/bootstrap.min.js'></script>
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/libs/pace.min.js'></script>
        <!-- Plugins and scripts required by all views -->
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/libs/Chart.min.js'></script>
        <!-- GenesisUI main scripts -->
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/app.js'></script>
        <!-- Plugins and scripts required by this views -->
        <!-- Custom scripts required by this view -->
        <script src='/admin/bootstrap/x264_acp_v4/assets/js/views/main.js'></script>
    </body>
</html>");
?>