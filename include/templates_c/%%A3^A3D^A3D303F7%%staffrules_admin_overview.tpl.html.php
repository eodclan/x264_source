<?php /* Smarty version 2.6.20, created on 2017-05-18 04:04:32
         compiled from staffrules_admin_overview.tpl.html */ ?>
                    <div class='row'>
                        <div class='col-lg-12'>
                            <div class='card'>
                                <div class='card-header'>
                                    <i class='fa fa-edit'></i>Staff Rules Admin Übersicht
...
"></a><?php echo $this->_tpl_vars['categories_list_1']['NAME']; ?>
 <a href="staffrulesadmin.php?action=editcategory&cid=<?php echo $this->_tpl_vars['categories_list_1']['ID']; ?>
"><img src="<?php echo $this->_tpl_vars['PIC_URL']; ?>
edit.png" border="0" alt="" /></a><a href="staffrulesadmin.php?action=deletecategory&cid=<?php echo $this->_tpl_vars['categories_list_1']['ID']; ?>
"><img src="<?php echo $this->_tpl_vars['PIC_URL']; ?>
...
<a href="staffrulesadmin.php?action=editquestion&qid=<?php echo $this->_tpl_vars['aq_list_1']['ID']; ?>
"><img src="<?php echo $this->_tpl_vars['PIC_URL']; ?>
edit.png" border="0" alt="" /></a><a href="staffrulesadmin.php?action=deletequestion&qid=<?php echo $this->_tpl_vars['aq_list_1']['ID']; ?>
"><img src="<?php echo $this->_tpl_vars['PIC_URL']; ?>
